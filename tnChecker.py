                        ...
                        if amount < self.config['main']['min'] or amount > self.config['main']['max']:
                            ...
                            try:
                                ...
                                if 'error' in txId:
                                    ...
                                    self.db.insExecuted(transaction['sender'], targetAddress, txId['result']['txid'], transaction['id'], amount, self.config['other']['fee'])
                            ...
                            if txId is None:
                                ...
                                self.otc.verifyTx(txId['result']['txid'], transaction['sender'], targetAddress)
                else:
